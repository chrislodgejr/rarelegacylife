...
export const metadata: Metadata = {
  ...
  description: "Draft insurance, annuity, securities, licensing, and educational-use disclosures.",
};
      ...
      <main className="bg-[#F7F5EF] px-4 py-14 sm:px-6 lg:px-8">
        <article className="mx-auto max-w-4xl rounded-3xl border border-black/10 bg-white p-6 shadow-xl sm:p-10">
          ...
          <div className="mt-5 rounded-2xl border border-[#C6A66B]/45 bg-[#FBF9F4] p-5 text-sm leading-6 text-[#4A4F4E]">
            This draft must be reviewed and approved by Rare Legacy Life Group&apos;s legal and
            compliance professionals before publication. Required firm, producer, license, and
            broker-dealer details remain placeholders below.
          </div>
          ...
          <div className="mt-10 space-y-8 text-sm leading-7 text-[#4A4F4E]">
            <Disclosure title="Licensing and availability">
              ...
              or to every person. [PRODUCER NAME / NPN / STATE LICENSE INFORMATION]
            </Disclosure>
            ...
            <Disclosure title="Securities-related services">
              ...
              representatives and their affiliated broker-dealer. [BROKER-DEALER NAME / MEMBER
              FINRA-SIPC DISCLOSURE / RELATIONSHIP DISCLOSURE]
            </Disclosure>
